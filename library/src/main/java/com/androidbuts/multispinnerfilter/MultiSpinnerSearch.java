...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public MultiSpinnerSearch(Context context) {
        ...
        this.setEmptyTitle("Ingredientes del producto");
        this.setHintText("Ingredientes del producto");
    ...
    public boolean performClick() {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.alert_dialog_listview_search, null);
