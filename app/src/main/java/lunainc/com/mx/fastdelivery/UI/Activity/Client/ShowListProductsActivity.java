...
public class ShowListProductsActivity extends AppCompatActivity implements ProductClientAdapter.ItemClickListener, ProductClientAdapter.ItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_products);
    ...
    private void initVars() {
        ...
        nameCategory = getIntent().getStringExtra("nameType");
    ...
    public ArrayList<Product> loadData(){
        ...
        apiService.getProductsClient("Accept", token, body).enqueue(new Callback<Product>() {
            @Override
            ...
            public void onFailure(@NotNull Call<Product> call, @NotNull Throwable t) {
                Toasty.warning(ShowListProductsActivity.this, "Ocurrio un error: " + t.getMessage(), Toast.LENGTH_SHORT, true).show();
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(ShowListProductsActivity.this, ProductDetailActivity.class);
